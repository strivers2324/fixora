...
// You can keep location logic if needed for users
const divisions = [
          ...
          <div className="mt-9 flex flex-col items-center justify-center w-full">
            ...
            <div className="mt-6">
              <h1 className="text-white text-3xl font-semibold text-center mb-2">
                Join Fixora as a User!
              </h1>
              <p className="text-teal-100 text-center text-xl text-sm mb-4">
                Find trusted service providers near you. Sign up, book services,
                and enjoy a seamless home solution experience. Fixora is your
                one-stop platform for reliable and fast service at your
                fingertips!
              </p>
            </div>
          </div>
