    ...
    <div id="about-section" className="py-12 pt-0 bg-[#1d4b4a] text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 md:mt-20 max-w-4xl mx-auto text-left">
          ...
          <p className="text-lg text-gray-200 mb-4">At Fixora, we believe great service starts with trust.</p>
          <p className="text-lg text-gray-200 mb-4">
            Whether you need a quick fix or a skilled expert, our platform helps you connect with the right people near
            you.
          </p>
